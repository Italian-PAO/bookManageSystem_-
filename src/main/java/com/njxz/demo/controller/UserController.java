...
public class UserController {
    ...
    @ResponseBody
    public boolean returnBook(int BorrowingId,HttpServletRequest request){
        return userService.userReturnBook(BorrowingId,request);
    }
    ...
    public boolean borrowingBook( int bookId,HttpServletRequest request){
        if(userService.userBorrowingBook(bookId, request)){
            return true;
        }
        return false;
    }
